                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col">
                                <input type="text" name="ramal"class="form-control" value="<?php echo $row->ramal + 1; ?>">
                            </div>
                            <div class="col">
                                <input type="text" name="secret"class="form-control" value="<?php echo $row->ramal + 1; ?>@landell">
                            </div>
                            <div class="col">
