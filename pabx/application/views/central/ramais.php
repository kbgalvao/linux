<div class="row" >
    <div class="col-12">
        <form action="<?php echo base_url() ?>central/insert" method="post">
            <ul class="list-group">
                <li class="list-group-item active">Cadastrar ramal Asterisk </li>
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="secret"class="form-control" placeholder="Senha">
                        </div>
                        <div class="col">
                            <input type="text" name="context"class="form-control" placeholder="context">
                        </div>
                        <div class="col">
                            <input type="text" name="host"class="form-control" placeholder="dynamic">
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                            <div class="col-2">
                                ...
                                <label class="custom-control custom-radio">
                                    <input id="radio1" name="gravacaosaida" type="radio" class="custom-control-input" value="sim" >
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Sim</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input id="radio2" name="gravacaosaida" type="radio" class="custom-control-input" value="nao" checked="">
                                    <span class="custom-control-indicator"></span>
                            ...
                            <div class="col-2">
                                ...
                                <label class="custom-control custom-radio">
                                    <input id="radio1" name="gravacaoentrada" type="radio" class="custom-control-input" value="sim" >
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Sim</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input id="radio2" name="gravacaoentrada" type="radio" class="custom-control-input" value="nao" checked="">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Não</span>
                                </label>
                            </div>
