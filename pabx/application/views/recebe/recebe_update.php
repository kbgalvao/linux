<?php foreach ($query as $row): ?>
    <form action="<?php echo base_url() ?>recebe/update" method="post">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col">
                        <input type="text" name="ddr" class="form-control form-control-sm" value="<?php echo $row->ddr ?>">
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <input type="text" name="primeiro" class="form-control form-control-sm" value="<?php echo $row->ramal; ?>">
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="grava" id="inlineRadio1" value="grava"> Ativa gravação
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
        ...
        <a class="btn btn-danger" href="<?php echo base_url() ?>recebe/deletar/<?php echo $row->id ?>">Deletar <i class="fa fa-trash" aria-hidden="true"></i></a>
